package io.github.appspiriment.kolt.composeutils.components.containers
...
import io.github.appspiriment.kolt.composeutils.components.containers.types.AppsTopBarButton
import io.github.appspiriment.kolt.composeutils.components.containers.types.DrawerItem
import io.github.appspiriment.kolt.composeutils.components.containers.types.ScaffoldColors
...
fun DrawerState.DrawerLayoutMenuItem(
    ...
    if (item.showTopDivider) {
        HorizontalDivider(
            color = Kolt.colors.dividerColor,
            thickness = 0.5.dp,
