package io.github.appspiriment.kolt.composekmp.components.modifiers
...
/**
 * Draws a colored drop shadow behind the composable.
 *
 * Note: requires `android.hardware.renderscript` — avoid on software-rendered layers.
 */
