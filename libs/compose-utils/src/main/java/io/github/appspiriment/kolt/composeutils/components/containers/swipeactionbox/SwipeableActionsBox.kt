...
import io.github.appspiriment.kolt.composeutils.components.containers.swipeactionbox.SwipeAction
...
fun SwipeableActionsBox(
  ...
  backgroundUntilSwipeThreshold: Color = Kolt.colors.primary,
...
private fun ActionIconBox(
  ...
  Row(
    modifier = modifier
      ...
      .padding(horizontal = Kolt.sizes.paddingMedium),
