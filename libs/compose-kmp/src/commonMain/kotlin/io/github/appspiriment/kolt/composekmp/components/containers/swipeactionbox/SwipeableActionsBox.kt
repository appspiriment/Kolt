...
fun GetScreenWidthPercentageInPx(percentage: Float): Float {
  // ponytail: androidx.compose.ui.platform.LocalConfiguration is Android-only.
  // LocalWindowInfo.containerSize is core compose-ui and already reports pixels
  // on every target, so no density conversion is needed here.
